...
setEffect.fn.setPage2 = function () {
  $('.page-2 .envelope2').attr('class', 'envelope2 animated fadeInUp');
  $('.page-2 .envelope2 > div').attr('class', 'animated fadeInUp');
  $('.page-2 .letter').attr('class', 'letter animated fadeInUp');
  $('.fruits-top').attr('class', 'fruits-top animated fadeIn');
...
setEffect.fn.setPage3 = function() {
  ...
  $('.page-3 .person').addClass('fadeIn');
  $('.page-3 .person3').attr('class', 'person person3 animated fadeInRight');
  ...
  $('.page-3 .selfie').addClass('el-flash');
}
